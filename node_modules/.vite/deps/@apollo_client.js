...
function readMultipartBody(response, observer) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    var decoder, contentType, delimiter, boundaryVal, boundary, buffer, iterator, running, _d, value, done, chunk, bi, message, i, headers, contentType_1, body, result2;
    var _e;
          ...
          while (bi > -1) {
            ...
            if (message.trim()) {
              ...
              try {
                ...
                if (Object.keys(result2).length > 1 || "data" in result2 || "incremental" in result2 || "errors" in result2) {
                  (_b = observer.next) === null || _b === void 0 ? void 0 : _b.call(observer, result2);
                }
              } catch (err) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a5) {
        ...
        return [2, resultPromise.then(function(result2) {
          ...
          var isClientField = (_b = (_a6 = field.directives) === null || _a6 === void 0 ? void 0 : _a6.some(function(d) {
...
var InternalState = function() {
  ...
  InternalState2.prototype.asyncUpdate = function(signal) {
    var _this = this;
    return new Promise(function(resolve, reject) {
  ...
  InternalState2.prototype.createWatchQueryOptions = function(_a5) {
    ...
    var skip = _a5.skip, ssr = _a5.ssr, onCompleted = _a5.onCompleted, onError = _a5.onError, defaultOptions2 = _a5.defaultOptions, otherOptions = __rest(_a5, ["skip", "ssr", "onCompleted", "onError", "defaultOptions"]);
...
function useLazyQuery(query, options) {
  var _a5;
  var abortControllersRef = (0, import_react3.useRef)(/* @__PURE__ */ new Set());
  ...
  var internalState = useInternalState(useApolloClient(options && options.client), (_a5 = merged === null || merged === void 0 ? void 0 : merged.query) !== null && _a5 !== void 0 ? _a5 : query);
  ...
  (0, import_react5.useEffect)(function() {
    ...
    var subscription2 = observable.subscribe({
      next: function(fetchResult) {
        ...
        setResult(result3);
        if ((_a6 = ref.current.options) === null || _a6 === void 0 ? void 0 : _a6.onData) {
      ...
      error: function(error) {
        ...
        (_b2 = (_a6 = ref.current.options) === null || _a6 === void 0 ? void 0 : _a6.onError) === null || _b2 === void 0 ? void 0 : _b2.call(_a6, error);
      },
      complete: function() {
        var _a6, _b2;
        if ((_a6 = ref.current.options) === null || _a6 === void 0 ? void 0 : _a6.onComplete) {
...
function useFragment_experimental(options) {
  ...
  var fragment = options.fragment, fragmentName = options.fragmentName, from2 = options.from, _a5 = options.optimistic, optimistic = _a5 === void 0 ? true : _a5, rest = __rest(options, ["fragment", "fragmentName", "from", "optimistic"]);
